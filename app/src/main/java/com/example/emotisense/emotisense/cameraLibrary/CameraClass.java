...
import com.example.emotisense.emotisense.R;
...
public class CameraClass extends Activity{
	...
	private final String LOG_TAG = "CameraLibrary";
...
//        Log.d("CameraClass", "Starting Camera class");
...
//                        MediaStore.Images.Media.insertImage(getContentResolver(), CaptureImage, Title , "");
	...
	public void CreateView(){
		...
		imgCapture.setImageResource(R.drawable.happy);
